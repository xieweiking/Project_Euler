...
package object problem_027 extends Problem {

    def question = """| Euler published the remarkable quadratic formula:
                      |
                      |                                  n^2 + n + 41
                      |
                      ...
                      |
                      | Using computers, the incredible formula  n^2 - 79*n + 1601 was discovered, which produces 80
